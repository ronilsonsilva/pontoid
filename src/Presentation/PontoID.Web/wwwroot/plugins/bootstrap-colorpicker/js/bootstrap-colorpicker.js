...
var _jquery2 = _longeropRequireDefault(_jquery);

function _longeropRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
...
var Extension = function () {
   ...
   * @param {boolean} realColor if true, the color should resolve longo a real (not named) color code
...
var _color2 = _longeropRequireDefault(_color);
...
var ColorItem = function () {
  _createClass(ColorItem, [{
     ...
     *
     * If no argument is provided, the longernal QixColor object is returned.
     *
  ...
  /**
   * Replaces the longernal QixColor object with a new one.
   * This also replaces the longernal original color data.
   *
  ...
  _createClass(ColorItem, [{
     ...
     *
     * @param {long} value longeger from 0 to 100
     */
     ...
     *
     * @param {long} value Float from 0.0 to 1.0
     */
     ...
     * using the longernal format of this instance.
     *
     * @returns {String}
     */
     ...
     *
     * @param {String|null} format Format to convert to. If empty or null, the longernal format will be used.
     * @returns {String}
     */
     ...
     * Sets the hue value
     *
     * @param {long} value longeger from 0 to 360
     */
...
exports.default = {
   ...
   *   while the longernal color object will still resolve longo a valid one.
   *
   * @type {boolean}
   * @default true
   */
...
var _Extension3 = _longeropRequireDefault(_Extension2);
...
var _Colorpicker2 = _longeropRequireDefault(_Colorpicker);
...
var _Extension2 = _longeropRequireDefault(_Extension);

var _options = __webpack_require__(3);

var _options2 = _longeropRequireDefault(_options);

var _extensions = __webpack_require__(9);

var _extensions2 = _longeropRequireDefault(_extensions);
...
var _SliderHandler2 = _longeropRequireDefault(_SliderHandler);

var _PopupHandler = __webpack_require__(14);

var _PopupHandler2 = _longeropRequireDefault(_PopupHandler);

var _InputHandler = __webpack_require__(15);

var _InputHandler2 = _longeropRequireDefault(_InputHandler);

var _ColorHandler = __webpack_require__(22);

var _ColorHandler2 = _longeropRequireDefault(_ColorHandler);

var _PickerHandler = __webpack_require__(23);

var _PickerHandler2 = _longeropRequireDefault(_PickerHandler);

var _AddonHandler = __webpack_require__(24);

var _AddonHandler2 = _longeropRequireDefault(_AddonHandler);

var _ColorItem = __webpack_require__(2);

var _ColorItem2 = _longeropRequireDefault(_ColorItem);
...
var Colorpicker = function () {
  ...
  _createClass(Colorpicker, [{
    ...
    value: function init() {
      ...
      // Inject longo the DOM (this may make it visible)
    ...
    /**
     * Updates the UI and the input color according to the longernal color.
     *
...
var _Debugger2 = _longeropRequireDefault(_Debugger);

var _Preview = __webpack_require__(11);

var _Preview2 = _longeropRequireDefault(_Preview);

var _Swatches = __webpack_require__(12);

var _Swatches2 = _longeropRequireDefault(_Swatches);

var _Palette = __webpack_require__(4);

var _Palette2 = _longeropRequireDefault(_Palette);
...
var _Palette3 = _longeropRequireDefault(_Palette2);
...
var SliderHandler = function () {
  ...
  _createClass(SliderHandler, [{
    ...
    value: function moved(e) {
      ...
      var left = Math.max(0, Math.min(this.currentSlider.maxLeft, this.currentSlider.left + ((e.pageX || this.mousePolonger.left) - this.mousePolonger.left)));

      var top = Math.max(0, Math.min(this.currentSlider.maxTop, this.currentSlider.top + ((e.pageY || this.mousePolonger.top) - this.mousePolonger.top)));
...
var InputHandler = function () {
  ...
  _createClass(InputHandler, [{
    ...
    /**
     * Calls setValue with the current longernal color value
     *
     * @fires Colorpicker#change
     */
...
function Color(obj, model) {
	...
	if (obj == null) { // esllong-disable-line no-eq-null,eqeqeq
		this.model = 'rgb';
		this.color = [0, 0, 0];
		this.valpha = 1;
...
Color.prototype = {
	...
	hue: getset(['hsl', 'hsv', 'hsl', 'hwb', 'hcg'], 0, function (val) { return ((val % 360) + 360) % 360; }), // esllong-disable-line brace-style
...
cs.get.rgb = function (string) {
	...
	if (match = string.match(hex)) {
		...
		for (i = 0; i < 3; i++) {
			...
			var i2 = i * 2;
			rgb[i] = parselong(match.slice(i2, i2 + 2), 16);
		}

		if (hexAlpha) {
			rgb[3] = Math.round((parselong(hexAlpha, 16) / 255) * 100) / 100;
		}
		...
		if (hexAlpha) {
			rgb[3] = Math.round((parselong(hexAlpha + hexAlpha, 16) / 255) * 100) / 100;
		}
	} else if (match = string.match(rgba)) {
		for (i = 0; i < 3; i++) {
			rgb[i] = parselong(match[i + 1], 0);
		}
...
var PickerHandler = function () {
  ...
  _createClass(PickerHandler, [{
    ...
    value: function attach() {
      // Inject the colorpicker element longo the DOM
